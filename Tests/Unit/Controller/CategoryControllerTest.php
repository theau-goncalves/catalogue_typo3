...
/**
 * Test case for class Ghtcatalogue\GhtCatalogue\Controller\CategoryController.
 *
...
class CategoryControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Ghtcatalogue\GhtCatalogue\Controller\CategoryController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Ghtcatalogue\\GhtCatalogue\\Controller\\CategoryController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllCategoriesFromRepositoryAndAssignsThemToView()
	{
		...
		$categoryRepository = $this->getMock('Ghtcatalogue\\GhtCatalogue\\Domain\\Repository\\CategoryRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$category = new \Ghtcatalogue\GhtCatalogue\Domain\Model\Category();
